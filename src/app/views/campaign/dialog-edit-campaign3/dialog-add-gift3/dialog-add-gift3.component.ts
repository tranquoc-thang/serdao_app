...
@Component({
	selector: 'app-dialog-add-gift3',
	templateUrl: './dialog-add-gift3.component.html',
	styleUrls: ['./dialog-add-gift3.component.scss'],
	providers: [DialogService],
})
export class DialogAddGift3Component extends BaseComponent implements OnInit {
	constructor(
	...
	ngOnInit(): void {
		...
		this.addGift3Form = this.formBuilder.group({
			txtPointExchange: [
				'',
				{
					validators: [
