...
@Component({
  selector: 'app-dialog-edit-normal-or-special-gift',
  templateUrl: './dialog-edit-normal-or-special-gift.component.html',
  styleUrls: ['./dialog-edit-normal-or-special-gift.component.scss']
})
export class DialogEditNormalOrSpecialGiftComponent extends BaseComponent implements OnInit {
  ...
  editNormalOrSpecialForm!: FormGroup;
  ruleList!: {}[];
  giftList!: {}[];
  ...
  currentFile!: string;
  isEditNormalGift!: boolean;

  ngOnInit(): void {
    this.isEditNormalGift = this.config.data.isEditNormalGift
    ...
    this.editNormalOrSpecialForm = this.formBuilder.group({
      txtPointExchange: [
        '',
        {
          validators: [
  ...
  isDisable(): boolean {
    return this.editNormalOrSpecialForm.valid;
  }
