...
@Component({
  selector: 'app-dialog-add-monthly-gift',
  templateUrl: './dialog-add-special-gift.component.html',
  styleUrls: ['./dialog-add-special-gift.component.scss'],
  providers: [DialogService]
})
export class DialogAddSpecialGiftComponent
