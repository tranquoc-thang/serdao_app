...
@Component({
  selector: 'app-dialog-add-quarterly-gift',
  templateUrl: './dialog-add-quarterly-gift.component.html',
  styleUrls: ['./dialog-add-quarterly-gift.component.scss'],
  providers: [DialogService]
})
export class DialogAddQuarterlyGiftComponent
