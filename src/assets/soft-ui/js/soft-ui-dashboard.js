...
//     e.getAttribute("checked") ? (a.classList.remove(...t), a.setAttribute("navbar-scroll", "false"), navbarBlurOnScroll("navbarBlur"), e.removeAttribute("checked")) : (a.classList.add(...t), a.setAttribute("navbar-scroll", "true"), navbarBlurOnScroll("navbarBlur"), e.setAttribute("checked", "true"))
// }
...
// }, navbar && "true" == navbar.getAttribute("navbar-scroll") && buttonNavbarFixed && buttonNavbarFixed.setAttribute("checked", "true"));
